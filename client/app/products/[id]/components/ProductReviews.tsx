            ...
            <div className="flex flex-row gap-7 py-4">
                <div className="flex flex-row gap-4 items-center rounded-lg w-full px-4 justify-center">
                    <div className="flex flex-col w-full h-full">
                        <h1 className="text-[10rem] font-medium font-inter p-0 m-0">
                            {avarageRating}<span className="text-3xl font-medium text-[#331d67]">/ 5</span>
                        </h1>
                        <h1 className="text-lg font-medium text-gray-500">({totalReviews} Reviews)</h1>
                    </div>
