        ...
        {data.map((item, index) => (
          ...
          >
            ...
            <div className="flex flex-col h-full justify-between">
              <h2 className="text-sm mb-2 text-gray-400 text-start font-medium font-roboto capitalize">
                {item.header}
              </h2>
              ...
              <p className={`${item.growthType === "up" ? "text-green-500" : "text-red-400"} flex gap-1 font-semibold items-center text-sm`}>
                ...
                {item.percentile}
                <span className="text-gray-400 ml-2 font-normal">{item.discription}</span>
              </p>
            </div>
